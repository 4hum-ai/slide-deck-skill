#!/usr/bin/env python3
"""Generate an example deck introducing agent skills and the skills marketplace."""
...
def build_deck() -> dict:
    ...
    intro = slide(
        [
            ...
            shape(0, 0, 1920, 1080, "background", shape="rectangle", stroke_width=0, opacity=0.7),
            *title_chip("OPEN ACADEMY AGENTS", 92, 74, 350),
            ...
            line(104, 710, 620, 3, stroke="accent", stroke_width=5),
            text("caption", 106, 750, 900, 58, "Generated from examples/agent_skills_marketplace.py."),
        ],
    ...
    why_skills = slide(
        [
            *title_chip("01 / WHY SKILLS", 92, 72, 260),
    ...
    anatomy = slide(
        [
            *title_chip("02 / ANATOMY", 92, 72, 250),
            ...
            chart(
                ...
                780,
                520,
                ["Trigger", "Workflow", "Assets", "Validation", "Handoff"],
    ...
    runtime = slide(
        [
            *title_chip("03 / RUNTIME FLOW", 92, 72, 310),
    ...
    marketplace = slide(
        [
            *title_chip("04 / MARKETPLACE", 92, 72, 300),
    ...
    takeaway = slide(
        [
            ...
            shape(0, 0, 1920, 1080, "background", shape="rectangle", stroke_width=0, opacity=0.75),
            *title_chip("05 / TAKEAWAY", 92, 72, 275),
    ...
    return deck(
        "Agent Skills & Skills Marketplace",
        [
            section("Agent Skills", [intro, why_skills, anatomy, runtime]),
